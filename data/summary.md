I'm a **Senior Software Engineer** working as part of the **Graphics Software Infrastructure team** for past 5 years at [Qualcomm](https://www.qualcomm.com). Contributing to enabling development of the next-generation flagship [Snapdragon GPUs](https://www.qualcomm.com/snapdragon) and [Adreno](https://www.qualcomm.com/adreno) graphics drivers validation at scale. Before that, started as an Intern and joined as a **Data Science Developer** at [KORE Wireless](https://www.korewireless.com) to enable ML based solutions for IoT devices for Anomaly Detection and Auto-thresholding using Clustering-based models to enhace their **SecurityPro** offering for a year. 
...
Driven by building reliable, delightful tools that create lasting impact.
